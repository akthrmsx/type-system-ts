    ...
    fn equals(&self, other: &Self) -> bool {
        match (self, other) {
            ...
            (
                ...
                properties1.len() == properties2.len()
                    && properties1.iter().all(|property1| {
                        properties2.iter().any(|property2| {
                            property1.name == property2.name && property1.ty.equals(&property2.ty)
                        })
                    })
            }
            _ => self == other,
